...
//            }
 ...
 //                   deviceTemp.labels(rig.v4.mmv.workerName, devices[0].dsv.name, devices[0].dsv.id, devices[0].dsv.deviceClass).set(device.odv.find(entry => entry.key === "Temperature").value);
                    deviceLoad.labels(rig.v4.mmv.workerName, device[0].dsv.name, device[0].dsv.id, device[0].dsv.deviceClass).set(device.odv.find(entry => entry.key === "Load").value);
                    devicePower.labels(rig.v4.mmv.workerName, device[0].dsv.name, device[0].dsv.id, device[0].dsv.deviceClass).set(device.powerUsage);
                    deviceStatusInfo.labels(rig.v4.mmv.workerName, rig.stats[0].v4.versions[1], device[0].dsv.name, device[0].dsv.id, device[0].dsv.deviceClass, device[0].mdv.state).set(1);
                    
                    device.speeds.forEach(speed => {
                        deviceSpeed.labels(rig.v4.mmv.workerName, device[0].dsv.name, device[0].dsv.id, devices[0].dsv.deviceClass, speed.algorithm, speed.displaySuffix).set(+speed.speed);
                    });
                } catch (e) {
